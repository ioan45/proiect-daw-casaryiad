...
<nav class="nav nav-pills navbar sticky-top navbar-expand-lg navbar-dark navbar-bg-color">
    <div class="container-lg">
        ...
        <div class="collapse navbar-collapse" id="NAV">
            <ul class="navbar-nav me-auto mt-3 mt-lg-0 bg-lg-light">
                <li class="nav-item">
                    <a id="acasa" class="nav-link px-3" href="/">ACASĂ</a>
                </li>
                <hr class="text-light my-1 d-lg-none">
                <li class="nav-item">
                ...
                <hr class="text-light my-1 d-lg-none">
                <li class="nav-item">
                    <a id="accesorii" class="nav-link px-3" href="/accesorii">ACCESORII</a>
                </li>
                <?php
                    ...
                    {
                        echo '<hr class="text-light my-1 d-lg-none">';
